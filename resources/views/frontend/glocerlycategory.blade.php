							...
							<form> 
									<div class="dropdown search-box">
										  ...
										  <ul class="dropdown-menu liststyling">
										    ...
										    <li><a href="#">Aagri Restaurants <span class="glyphicon glyphicon-chevron-right"></span> </a></li>

										    <li><a href="#">African Resturant <span class="glyphicon glyphicon-chevron-right"></span> </a></li>

										    <li><a href="#">American Resturant <span class="glyphicon glyphicon-chevron-right"></span></a></li>

										    <li><a href="#">African Resturant <span class="glyphicon glyphicon-chevron-right"></span></a></li>

										    <li><a href="#">Australian Resturant <span class="glyphicon glyphicon-chevron-right"></span></a></li>

										    <li><a href="#">Andhara Resturant <span class="glyphicon glyphicon-chevron-right"></span></a></li>
		...
		`	<div class="col-sm-7 col-sm-offset-2 col-xs-10 col-xs-offset-1 col-md-6 col-md-offset-2 col-lg-6 col-lg-offset-2">
				<ul>
					...
					<hr>
				 	<li>
						<a href='#'>
							<span title="Aagri Restaurants">Aagri Restaurants</span>
