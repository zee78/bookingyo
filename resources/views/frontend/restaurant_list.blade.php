		...
		<div class="col-md-9-5 col-xs-12">
			...
			<div class="tab-content">
				<div class="tab pane" id="list-view">
					...
					<div class="col-md-3">
						<img src="{{('frontend-assets/static-images/listing/restaurant_1.jpeg')}}" style="width: 100%;height: 192px;">
					...
					<div class="col-md-9">
						<div class="row">
							...
							<div class="col-md-3 table-btn">
								<a class="btn btn-success" href="{{url('/table_booking')}}">Book a Table<i class="fa fa-chevron-circle-right fa_arrow"></i></a>
								<a class="btn btn-success" href="{{url('/food_order')}}">Order Online<i class="fa fa-chevron-circle-right fa_arrow"></i></a>
							</div>
						</div>
