		...
		<div class="bottom-footer-section" id="bottom-categry" style="display: none;">
			...
			<div class="row catgry-list">
				...
				<div class="col-md-4 col-xs-6">
					...
					<div class="col-md-9">
						<h5><b>Entertainment & Events</b></h5>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
						tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
						quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo.</p>
					</div>
				...
				<div class="col-md-4 col-xs-6">
					...
					<div class="col-md-9">
						<h5><b>Book a Table Booking</b></h5>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
						tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
						quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo.</p>
					</div>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<p class="copyright">Copyrights &copy; 2018. All Rights Reserved. <a href="">Privacy</a>| <a href="">Terms</a>| <a href="">Infringement</a> &nbsp; &nbsp; View BookingYo on Smartphone | Mobile</p>
				</div>
			</div>
		</div>
	</div>
